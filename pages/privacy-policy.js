...
const PrivacyPolicy = () => {
    return (
        ...
        <div className="wrapper">
            ...
            <div className='policy-mainbx py-90'>
                <div className='container'>
                    <div className='card-header-box'>
                        <h5>Current as of 20 Jan 2022</h5>
                        <h1>Privacy Policy</h1>
                        <h4 className='mx-wt-700'>Your privacy is important to us at Untitled. We respect your privacy regarding any information we may collect from you across our website.</h4>   
                    </div>
                </div>
            </div>
            
            <div className='content-decription-bx pb-90'>
                <div className='container'>
                    <div className='custom-contain-sml mx-wt-720 m-auto'>
